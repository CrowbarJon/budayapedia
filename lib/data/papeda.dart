...
final List<ModuleContent> papedaModules = [
    ...
    ModuleContent(
        ...
        contentText: 'Uji pengetahuan Anda mengenai sumber daya sagu, teknik mengaduk Papeda, dan rempah-rempah yang wajib ada di Kuah Kuning.',
        isQuiz: true,
    ),
    ...
    ModuleContent(
        ...
        contentText: 'Selamat! Anda telah menguasai seni memasak Papeda dan Kuah Kuning. Saatnya menguji keterampilan Anda.',
        isQuiz: true,
    ),
];