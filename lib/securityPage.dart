...
class _SecurityPageState extends State<SecurityPage> {
    ...
    void _sendSecurityEmailNotification(String action) {
        ...
        if (user != null) {
            debugPrint("SIMULASI EMAIL: Notifikasi keamanan '$action' dikirim ke ${user!.email}");
        }
    }
                    ...
                    actions: [
                        ...
                        ElevatedButton(
                            onPressed: () {
                                ...
                                _showSuccessSnackbar("Kode OTP telah diminta. Harap cek email Anda!"); 
                            },
                    ...
                    actions: [
                        ...
                        ElevatedButton(
                            onPressed: () async {
                                ...
                                if (otp.isEmpty || otp != "123456") { // Kode '123456' masih simulasi di sini
                    ...
                    actions: [
                        ...
                        ElevatedButton(
                            onPressed: () {
                                ...
                                // >>> PESAN SIMULASI DIHAPUS, DIGANTI PESAN SUKSES ASLI <<<
                                _showSuccessSnackbar("Kode OTP 2FA telah diminta. Harap cek email Anda!");
                            },
                            child: const Text("Minta OTP"),
                        ),
                    ],
                    ...
                    actions: [
                        ...
                        ElevatedButton(
                            onPressed: () async {
                                ...
                                if (otp.isEmpty || otp != "654321") { // Kode '654321' masih simulasi di sini
                                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Kode OTP salah atau kedaluwarsa!")));
                                    return;
                                }
