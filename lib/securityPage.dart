...
class _SecurityPageState extends State<SecurityPage> {
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                if (newPassword.length < 6) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text("Sandi baru minimal 6 karakter!"),
                    ),
                  );
                  return;
                }
                ...
                if (user != null) {
                  try {
                    ...
                    _showSuccessSnackbar(
                      "Kata Sandi berhasil diubah! Email konfirmasi telah dikirim.",
                    );
    ...
    await showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text(
            "Kami akan mengirimkan Kode OTP ke email Anda saat ini (${user?.email ?? 'N/A'}) untuk memverifikasi kepemilikan.",
          ),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
              ...
              onPressed: () async {
                ...
                if (user != null &&
                  ...
                  try {
                    ...
                    if (mounted) Navigator.pop(context);
                    _showSuccessSnackbar(
                      "Link verifikasi telah dikirim ke email baru Anda!",
                    );
    ...
    await showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text(
            "Kami akan mengirimkan Kode OTP ke email Anda saat ini (${user?.email ?? 'N/A'}) untuk mengaktifkan Verifikasi Dua Langkah.",
          ),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
    ...
    await showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text(
            "Apakah Anda yakin ingin menonaktifkan Verifikasi Dua Langkah? Ini akan mengurangi keamanan akun Anda.",
          ),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
  ...
  Widget _buildToggleSecurityCard(
    IconData icon,
    String title,
    String subtitle,
    bool value,
  ...
  Widget build(BuildContext context) {
    ...
    final String statusText = isSecurityGood
        ...
        child: Column(
          ...
          children: [
            ...
            _buildToggleSecurityCard(
              ...
              _is2faEnabled
                  ? 'Aktif. Selalu minta kode kedua saat login.'
                  : 'Nonaktif. Keamanan akun lebih rentan.',
              _is2faEnabled,
            ),
